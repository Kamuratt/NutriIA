...
def atualizar_schema():
    ...
    try:
        ...
        # --- Alteração 1: Adicionar coluna de status na tabela 'receitas' ---
        try:
            ...
            """)
            print("✔️ Coluna 'processado_pela_llm' adicionada à tabela 'receitas'.")
        except sqlite3.OperationalError as e:
            # Este erro acontece se a coluna já existir. É um comportamento esperado.
            if "duplicate column name" in str(e):
                print("⚠️  Aviso: A coluna 'processado_pela_llm' já existe.")
            else:
                raise e # Se for outro erro, mostra na tela

        # --- Alteração 2: Criar a nova tabela 'ingredientes_estruturados' ---
        cursor.execute("""
        ...
        """)
        print("✔️ Tabela 'ingredientes_estruturados' verificada/criada.")
