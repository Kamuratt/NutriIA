;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CSbUIQNN.js", "./src-legacy-Bw3jlBBM.js", "./en-legacy-s6H-lEA2.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-BXBaeAHj.js", "./icon-legacy-G70PJc8a.js", "./overlay-legacy-Cejp9MX-.js", "./empty-legacy-CsIOGMHW.js", "./useMessage-legacy-DsPzQPKW.js", "./useTelemetry-legacy-K-mG0KNq.js", "./useToast-legacy-BNFd7XMO.js", "./sanitize-html-legacy-Cack6L-S.js", "./path-browserify-legacy-BQKq4wLb.js", "./constants-legacy-CvA6xS_6.js", "./merge-legacy-B2foMX1A.js", "./useRootStore-legacy-BMRt4TVg.js", "./dateformat-legacy-BaeIHy_2.js", "./useDebounce-legacy-CQgGMAey.js", "./useExternalHooks-legacy-JPDKkvXd.js", "./useStyles-legacy-DnD2qvTK.js", "./npsSurvey.store-legacy-CdkwEWy8.js", "./cloudPlan.store-legacy-GVLMfBwn.js", "./templates.store-legacy-CnhRjinz.js", "./focusPanel.store-legacy-U5eteqRp.js", "./useWorkflowSaving-legacy-C6zZ8vrh.js", "./nodeCreator.store-legacy-fRjvO05p.js", "./nodeIcon-legacy-8jhXeJb9.js", "./folders.store-legacy-I_vXgpGZ.js", "./NodeIcon-legacy-B-R6YtUx.js", "./ProjectIcon-legacy-DOA7aXDu.js", "./ProjectCardBadge-legacy-CG1uyv2p.js", "./usage.store-legacy-DqRtUl4a.js", "./Draggable-legacy-CQvDU-pL.js", "./EnterpriseEdition.ee-legacy-DXkl90Fu.js", "./TimeAgo-legacy-Cqf5Bvbr.js", "./orderBy-legacy-DpgU2Zh_.js", "./ProjectSharing-legacy-Czquz9Tz.js", "./TagsDropdown-legacy-ypT1DSt7.js", "./WorkflowTagsDropdown-legacy-DcqTajh1.js", "./insights.store-legacy-DDERScnh.js", "./insights.constants-legacy-Cw1kp4kH.js", "./insights.utils-legacy-8QuZWCxI.js", "./mcp.constants-legacy-bzwWktiU.js", "./useMcp-legacy-ui1IDlfa.js", "./personalizedTemplatesV3.store-legacy-BeQfphPw.js", "./useWorkflowActivate-legacy-CvzMGJiQ.js", "./ProjectBreadcrumb-legacy-CDfNR4vV.js", "./WorkflowActivator-legacy-B2EjxQRa.js", "./aiTemplatesStarterCollection.store-legacy-B3mA01je.js", "./readyToRun.store-legacy-DbIg0u1J.js", "./readyToRunWorkflows.store-legacy-Dalzm_uh.js", "./PageViewLayout-legacy-BQS3XeR_.js", "./EmptySharedSectionActionBox-legacy-CElwzma0.js", "./ResourcesListLayout-legacy-DKJ1gamB.js", "./ResourceFiltersDropdown-legacy-C5WBrcpH.js", "./ProjectHeader-legacy-CyNsjfG8.js", "./mcp.store-legacy-DvXqDZwL.js", "./smartDecimal-legacy-D0tIAr6q.js", "./InsightsSummary-legacy-vy2QHREw.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, createElementBlock, createCommentVNode, unref, ref, onBeforeUnmount, createVNode, onScopeDispose, defineComponent, toDisplayString, createBlock, onMounted, Fragment, normalizeClass, watch, renderSlot, withCtx, openBlock, withModifiers, renderList, createTextVNode, createSlots, useTemplateRef, resolveComponent, vShow, createBaseVNode, withDirectives, useI18n, N8nIcon_default, N8nInfoTip_default, N8nHeading_default, N8nSelect_default, N8nCallout_default, N8nOption_default, N8nText_default, N8nActionBox_default, N8nButton_default, N8nInputLabel_default, N8nCheckbox_default, N8nCard_default, N8nInlineTextEdit_default, N8nBadge_default, N8nBreadcrumbs_default, N8nActionToggle_default, N8nTags_default, N8nLink_default, N8nLoading_default, N8nTooltip_default, __plugin_vue_export_helper_default, useRouter, createEventBus, useRoute, useMessage, useSettingsStore, useSourceControlStore, useProjectsStore, ResourceType, FOLDER_LIST_ITEM_ACTIONS, useUIStore, ProjectTypes, ILLEGAL_FOLDER_CHARACTERS, useDocumentTitle, getEasyAiWorkflowJson, PROJECT_MOVE_RESOURCE_MODAL, FOLDER_NAME_MAX_LENGTH, FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, FOLDER_NAME_ONLY_DOTS_REGEX, useTagsStore, STORES, useUsersStore, usePostHog, COMMUNITY_PLUS_ENROLLMENT_MODAL, useWorkflowsStore, useNodeTypesStore, useTelemetry, useStorage, useToast, DUPLICATE_MODAL_KEY, EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, EXPERIMENT_TEMPLATE_RECO_V2_KEY, PROJECT_ROOT, VIEWS, EXPERIMENT_TEMPLATE_RECO_V3_KEY, jsonParse, getResourcePermissions, WORKFLOW_SHARE_MODAL_KEY, TEMPLATE_ONBOARDING_EXPERIMENT, LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, EnterpriseEditionFeature, MODAL_CONFIRM, DEFAULT_WORKFLOW_PAGE_SIZE, defineStore, require_dateformat, require_debounce, useDebounce, useCloudPlanStore, useTemplatesDataQualityStore, trackTemplatesClick, TemplateClickSource, isExtraTemplateLinksExperimentEnabled, useTemplatesStore, useCalloutHelpers, useFoldersStore, NodeIcon_default, ProjectCardBadge_default, useUsageStore, Draggable_default, TimeAgo_default, WorkflowTagsDropdown_default, useInsightsStore, useMcp, usePersonalizedTemplatesV2Store, usePersonalizedTemplatesV3Store, FolderBreadcrumbs_default, WorkflowActivator_default, useAITemplatesStarterCollectionStore, useProjectPages, useReadyToRunStore, useReadyToRunWorkflowsStore, EmptySharedSectionActionBox_default, ResourcesListLayout_default, ProjectHeader_default, useMCPStore, InsightsSummary_default, __vite_style__, _hoisted_1$5, _hoisted_2$1, FolderCard_vue_vue_type_script_setup_true_lang_default, card, cardBadge$1, FolderCard_vue_vue_type_style_index_0_lang_module_default, cssModules$9, FolderCard_default, import_dateformat, _hoisted_1$4, WorkflowCard_vue_vue_type_script_setup_true_lang_default, cardLink, cardHeading, cardHeadingArchived, cardDescription, cardTags, cardActions, cardBadge, cardArchived, breadcrumbs, WorkflowCard_vue_vue_type_style_index_0_lang_module_default, cssModules$8, WorkflowCard_default, DEFAULT_EDGE, DEFAULT_MAX_SPEED, SIMPLE_TEMPLATES, PREDEFINED_TEMPLATES_BY_NODE, usePersonalizedTemplatesStore, SuggestedWorkflowCard_vue_vue_type_script_setup_true_lang_default, SuggestedWorkflowCard_vue_vue_type_style_index_0_lang_module_default, cssModules$7, SuggestedWorkflowCard_default, SuggestedWorkflows_vue_vue_type_style_index_0_lang_module_default, _sfc_main, _hoisted_1$3, cssModules$6, SuggestedWorkflows_default, NodeRecommendationCard_vue_vue_type_script_setup_true_lang_default$1, nodeCard$1, nodeIcon$1, emptyStateCardContent$2, NodeRecommendationCard_vue_vue_type_style_index_0_lang_module_default$1, cssModules$5, NodeRecommendationCard_default$1, _hoisted_1$2, TemplateRecommendationV2_vue_vue_type_script_setup_true_lang_default, nodeCardsContainer$1, TemplateRecommendationV2_vue_vue_type_style_index_0_lang_module_default, cssModules$4, TemplateRecommendationV2_default, NodeRecommendationCard_vue_vue_type_script_setup_true_lang_default, nodeCard, nodeIcon, emptyStateCardContent$1, NodeRecommendationCard_vue_vue_type_style_index_0_lang_module_default, cssModules$3, NodeRecommendationCard_default, _hoisted_1$1, TemplateRecommendationV3_vue_vue_type_script_setup_true_lang_default, nodeCardsContainer, TemplateRecommendationV3_vue_vue_type_style_index_0_lang_module_default, cssModules$2, TemplateRecommendationV3_default, EmptyStateLayout_vue_vue_type_script_setup_true_lang_default, emptyStateLayout, content, welcome, welcomeTitle, welcomeDescription, actionsContainer$1, actionCard, cardIcon, loading, cardContent, EmptyStateLayout_vue_vue_type_style_index_0_lang_module_default, cssModules$1, EmptyStateLayout_default, import_debounce, _hoisted_1, _hoisted_2, _hoisted_3, _hoisted_4, _hoisted_5, _hoisted_6, _hoisted_7, _hoisted_8, _hoisted_9, SEARCH_DEBOUNCE_TIME, FILTERS_DEBOUNCE_TIME, WorkflowsView_vue_vue_type_script_setup_true_lang_default, actionsContainer, emptyStateCard, emptyStateCardContent, emptyStateCardIcon, dragging, name, WorkflowsView_vue_vue_type_style_index_0_lang_module_default, cssModules, WorkflowsView_default;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        DUPLICATE_MODAL_KEY = _constantsLegacy00NJs.Fo;
        EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY = _constantsLegacy00NJs.Io;
        EXPERIMENT_TEMPLATE_RECO_V2_KEY = _constantsLegacy00NJs.Lo;
        PROJECT_ROOT = _constantsLegacy00NJs.Na;
        VIEWS = _constantsLegacy00NJs.Oo;
        EXPERIMENT_TEMPLATE_RECO_V3_KEY = _constantsLegacy00NJs.Ro;
        jsonParse = _constantsLegacy00NJs.Xi;
        getResourcePermissions = _constantsLegacy00NJs._r;
        WORKFLOW_SHARE_MODAL_KEY = _constantsLegacy00NJs.cs;
        TEMPLATE_ONBOARDING_EXPERIMENT = _constantsLegacy00NJs.ec;
        LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS = _constantsLegacy00NJs.hs;
        ...
        require_dateformat = _dateformatLegacy00VJs.t;
      }, function (_useDebounceLegacy00XJs) {
        require_debounce = _useDebounceLegacy00XJs.n;
        useDebounce = _useDebounceLegacy00XJs.t;
      }, function (_useExternalHooksLegacy00ZJs) {}, function (_useStylesLegacy00$Js) {}, function (_npsSurveyStoreLegacy015Js) {}, function (_cloudPlanStoreLegacy017Js) {
        useCloudPlanStore = _cloudPlanStoreLegacy017Js.t;
      }, function (_templatesStoreLegacy019Js) {
        useTemplatesDataQualityStore = _templatesStoreLegacy019Js.a;
        trackTemplatesClick = _templatesStoreLegacy019Js.i;
        TemplateClickSource = _templatesStoreLegacy019Js.n;
        isExtraTemplateLinksExperimentEnabled = _templatesStoreLegacy019Js.r;
        useTemplatesStore = _templatesStoreLegacy019Js.t;
      }, function (_focusPanelStoreLegacy01bJs) {}, function (_useWorkflowSavingLegacy01dJs) {}, function (_nodeCreatorStoreLegacy01nJs) {
        useCalloutHelpers = _nodeCreatorStoreLegacy01nJs._;
      }, function (_nodeIconLegacy01pJs) {}, function (_foldersStoreLegacy01xJs) {
        useFoldersStore = _foldersStoreLegacy01xJs.t;
      }, function (_NodeIconLegacy01zJs) {
        NodeIcon_default = _NodeIconLegacy01zJs.t;
      }, function (_ProjectIconLegacy029Js) {}, function (_ProjectCardBadgeLegacy02bJs) {
        ProjectCardBadge_default = _ProjectCardBadgeLegacy02bJs.t;
      }, function (_usageStoreLegacy02dJs) {
        useUsageStore = _usageStoreLegacy02dJs.t;
      }, function (_DraggableLegacy02nJs) {
        Draggable_default = _DraggableLegacy02nJs.t;
      }, function (_EnterpriseEditionEeLegacy02JJs) {}, function (_TimeAgoLegacy02NJs) {
        TimeAgo_default = _TimeAgoLegacy02NJs.t;
      }, function (_orderByLegacy02PJs) {}, function (_ProjectSharingLegacy02RJs) {}, function (_TagsDropdownLegacy02ZJs) {}, function (_WorkflowTagsDropdownLegacy02$Js) {
        WorkflowTagsDropdown_default = _WorkflowTagsDropdownLegacy02$Js.t;
      }, function (_insightsStoreLegacy037Js) {
        useInsightsStore = _insightsStoreLegacy037Js.t;
      }, function (_insightsConstantsLegacy039Js) {}, function (_insightsUtilsLegacy03bJs) {}, function (_mcpConstantsLegacy03dJs) {}, function (_useMcpLegacy03xJs) {
        useMcp = _useMcpLegacy03xJs.t;
      }, function (_personalizedTemplatesV3StoreLegacy03BJs) {
        usePersonalizedTemplatesV2Store = _personalizedTemplatesV3StoreLegacy03BJs.n;
        usePersonalizedTemplatesV3Store = _personalizedTemplatesV3StoreLegacy03BJs.t;
      }, function (_useWorkflowActivateLegacy03FJs) {}, function (_ProjectBreadcrumbLegacy03PJs) {}, function (_WorkflowActivatorLegacy03RJs) {
        FolderBreadcrumbs_default = _WorkflowActivatorLegacy03RJs.n;
        WorkflowActivator_default = _WorkflowActivatorLegacy03RJs.t;
      ...
      }, function (_readyToRunStoreLegacy041Js) {
        useProjectPages = _readyToRunStoreLegacy041Js.n;
        useReadyToRunStore = _readyToRunStoreLegacy041Js.t;
      }, function (_readyToRunWorkflowsStoreLegacy04lJs) {
        useReadyToRunWorkflowsStore = _readyToRunWorkflowsStoreLegacy04lJs.t;
      }, function (_PageViewLayoutLegacy04rJs) {}, function (_EmptySharedSectionActionBoxLegacy04zJs) {
        EmptySharedSectionActionBox_default = _EmptySharedSectionActionBoxLegacy04zJs.t;
      }, function (_ResourcesListLayoutLegacy04BJs) {
      ...
      }, function (_mcpStoreLegacy04HJs) {
        useMCPStore = _mcpStoreLegacy04HJs.t;
      ...
      execute: function () {
        ...
        emptyStateLayout = "_emptyStateLayout_13c47_123";
        content = "_content_13c47_131";
        welcome = "_welcome_13c47_139";
        welcomeTitle = "_welcomeTitle_13c47_143";
        welcomeDescription = "_welcomeDescription_13c47_147";
        actionsContainer$1 = "_actionsContainer_13c47_151";
        actionCard = "_actionCard_13c47_158";
        cardIcon = "_cardIcon_13c47_171";
        loading = "_loading_13c47_174";
        cardContent = "_cardContent_13c47_179";
          ...
          setup(__props) {
            ...
            */
            ...
            const shouldUseSimplifiedLayout = computed(() => {
              return !loading$1.value && readyToRunStore.getSimplifiedLayoutVisibility(route);
            });
