;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CSbUIQNN.js", "./useTelemetry-legacy-K-mG0KNq.js", "./constants-legacy-CvA6xS_6.js", "./useExternalHooks-legacy-JPDKkvXd.js", "./nodeCreator.store-legacy-DqBDzHVc.js"], function (_export, _context) {
    "use strict";

    var computed, useI18n, transformNodeType, injectWorkflowState, useCanvasStore, useWorkflowsStore, PUSH_NODES_OFFSET, useNodeTypesStore, sortNodeCreateElements, OPEN_AI_NODE_TYPE, MANUAL_TRIGGER_NODE_TYPE, WEBHOOK_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, TRIGGER_NODE_CREATOR_VIEW, AGENT_NODE_TYPE, BASIC_CHAIN_NODE_TYPE, NO_OP_NODE_TYPE, AI_CATEGORY_LANGUAGE_MODELS, OPEN_AI_ASSISTANT_NODE_TYPE, SPLIT_IN_BATCHES_NODE_TYPE, CHAIN_LLM_LANGCHAIN_NODE_TYPE, NodeConnectionTypes, QA_CHAIN_NODE_TYPE, SCHEDULE_TRIGGER_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, STICKY_NODE_TYPE, useExternalHooks, useNodeCreatorStore, useActions;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        CHAIN_LLM_LANGCHAIN_NODE_TYPE = _constantsLegacy00NJs.ba;
