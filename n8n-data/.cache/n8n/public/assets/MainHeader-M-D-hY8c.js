...
import { Dn as useSourceControlStore, Ei as nodeViewEventBus, En as useProjectsStore, Gn as hasPermission, Ir as ResourceType, Ni as useUIStore, On as ProjectTypes, Ro as useSettingsStore, Tn as useDocumentTitle, Wi as PROJECT_MOVE_RESOURCE_MODAL, Ys as useRootStore, _n as useTagsStore, a as useNDVStore, at as useEvaluationStore, bc as STORES, er as useUsersStore, mn as useWorkflowHelpers, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, vc as defineStore } from "./useTelemetry-EOV0Llso.js";
import { i as getBannerRowHeight, t as useToast } from "./useToast-BlMNYwds.js";
import "./sanitize-html-BuXr7o4T.js";
import "./path-browserify-DsmB_HMK.js";
import { Bs as EnterpriseEditionFeature, Jo as WORKFLOW_SHARE_MODAL_KEY, Js as TIME, No as MODAL_CONFIRM, Oo as IMPORT_WORKFLOW_URL_MODAL_KEY, T as TIME_SAVED_DOCS_URL, Uo as WORKFLOW_ACTIVE_MODAL_KEY, _ as EVALUATIONS_DOCS_URL, _r as getResourcePermissions, a as MAX_WORKFLOW_NAME_LENGTH, g as ERROR_WORKFLOW_DOCS_URL, lc as WORKFLOW_MENU_ACTIONS, mo as VIEWS, po as MAIN_HEADER_TABS, qo as WORKFLOW_SETTINGS_MODAL_KEY, rs as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, s as PLACEHOLDER_EMPTY_WORKFLOW_ID, xn as STICKY_NODE_TYPE, xo as DUPLICATE_MODAL_KEY, y as N8N_MAIN_GITHUB_REPO_URL } from "./constants-DvlTm3U4.js";
...
import { i as usePushConnectionStore } from "./useRunWorkflow-_-_hUnHE.js";
...
import { t as EnterpriseEdition_ee_default } from "./EnterpriseEdition.ee-BoNEV-MB.js";
import { t as SaveButton_default } from "./SaveButton-D1iDaopV.js";
import "./TagsDropdown-D6CYk5R8.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-CdEFZM1A.js";
import { r as MCP_DOCS_PAGE_URL, t as useMcp } from "./useMcp-_gyuyL1x.js";
...
import { t as PushConnectionTracker_default } from "./PushConnectionTracker-ByNVqY0h.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-BSXTJC8C.js";
import { t as usePushConnection } from "./usePushConnection-XZibrqm8.js";
import "./readyToRunWorkflows.store-C23cIyhu.js";
import "./readyToRunWorkflowsV2.store-BxZUJyXQ.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(unref($style).container) }, [
				...
				createBaseVNode("span", _hoisted_1, [unref(settingsStore).areTagsEnabled ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [isTagsEditEnabled.value && !(_ctx.readOnly || _ctx.isArchived) && (isNewWorkflow.value || workflowPermissions.value.update) ? (openBlock(), createBlock(WorkflowTagsDropdown_default, {
					...
					onClick: onTagsEditEnable
				}, null, 8, ["tag-ids"]))], 64)) : createCommentVNode("", true), createBaseVNode("span", _hoisted_3, [_ctx.isArchived ? (openBlock(), createBlock(unref(N8nBadge_default), {
					key: 0,
					class: "ml-3xs",
					theme: "tertiary",
					bold: "",
...
var WorkflowDetails_default = /* @__PURE__ */ __plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-51681533"]]);
