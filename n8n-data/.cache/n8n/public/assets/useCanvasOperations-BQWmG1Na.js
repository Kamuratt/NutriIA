...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-BGBKpT5S.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-Dc79aML5.js";
import { $ as getExecutionErrorToastConfiguration, An as useProjectsStore, Di as tryToParseNumber, Dr as useHistoryStore, Er as CanvasNodeRenderType, Fr as RemoveNodeCommand, G as isChatNode, Ht as useCredentialsStore, Ir as RenameNodeCommand, Js as useRootStore, Li as useUIStore, Lr as ReplaceNodeParametersCommand, Nr as MoveNodeCommand, Or as AddConnectionCommand, Pr as RemoveConnectionCommand, S as getNodesGroupSize, Si as isPresent, Sn as injectWorkflowState, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, b as getNewNodePosition, br as isValidNodeConnectionType, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, gc as defineStore, h as generateOffsets, i as usePostHog, kr as AddNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, qn as useCanvasStore, rt as useNodeTypesStore, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, u as DEFAULT_NODE_SIZE, wr as CanvasConnectionMode, xn as useNodeHelpers, yc as v4_default, zo as useSettingsStore } from "./useTelemetry-BxbCYDca.js";
import { t as useToast } from "./useToast-CKD06lpn.js";
import { $o as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, En as UPDATE_WEBHOOK_ID_NODE_TYPES, Fi as deepCopy, Fs as EnterpriseEditionFeature, Gr as require__baseUniq, Ii as isCommunityPackageName, Nr as require_cloneDeep, On as WEBHOOK_NODE_TYPE, Os as NDV_IN_FOCUS_PANEL_EXPERIMENT, St as FORM_TRIGGER_NODE_TYPE, _i as getSubworkflowId, co as VIEWS, di as getNodeOutputs, es as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, fi as getNodeParameters, li as getConnectionTypes, ns as LOCAL_STORAGE_LOGS_SYNC_SELECTION, oi as generateNodesGraph, qi as NodeConnectionTypes, ts as LOCAL_STORAGE_LOGS_PANEL_OPEN, ui as getNodeInputs, ws as CANVAS_ZOOMED_VIEW_EXPERIMENT, xn as STICKY_NODE_TYPE, zt as MCP_TRIGGER_NODE_TYPE } from "./constants-B1JYxPAR.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-DHlAhQH9.js";
