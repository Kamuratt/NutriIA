(function() {
	...
	var require_get_iterator_flattenable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(obj, stringHandling) {
			...
			return getIteratorDirect$9(anObject$11(method !== void 0 ? call$13(method, obj) : obj));
		};
	}));
	...
	var IteratorProxy$2 = createIteratorProxy$2(function() {
		...
		while (true) {
			if (inner = this.inner) try {
				result = anObject$10(call$12(inner.next, inner.iterator));
				if (!result.done) return result.value;
				this.inner = null;
			} catch (error) {
				iteratorClose$8(iterator, "throw", error);
			}
			result = anObject$10(call$12(this.next, iterator));
	...
	$$27({
		...
		if (flatMapWithoutClosingOnEarlyError) return call$12(flatMapWithoutClosingOnEarlyError, this, mapper);
	...
	var require_parse_json_string = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var at$2 = uncurryThis$17("".charAt);
		var slice$2 = uncurryThis$17("".slice);
		var exec$3 = uncurryThis$17(/./.exec);
		var codePoints = {
			"\\\"": "\"",
			"\\\\": "\\",
			"\\/": "/",
	...
	var at$1 = uncurryThis$16("".charAt);
	var slice$1 = uncurryThis$16("".slice);
	var exec$2 = uncurryThis$16(/./.exec);
	var push$4 = uncurryThis$16([].push);
	var IS_DIGIT = /^\d$/;
	...
	var require_array_buffer_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var slice = uncurryThis$12(ArrayBufferPrototype.slice);
