    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        Workflow = _constantsLegacy00NJs.Ir;
        MANUAL_CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00NJs.It;
        parseErrorMetadata = _constantsLegacy00NJs.Lr;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00NJs.Q;
        NodeConnectionTypes = _constantsLegacy00NJs.fa;
        AGENT_LANGCHAIN_NODE_TYPE = _constantsLegacy00NJs.ga;
        LOGS_EXECUTION_DATA_THROTTLE_DURATION = _constantsLegacy00NJs.oc;
        PLACEHOLDER_EMPTY_WORKFLOW_ID = _constantsLegacy00NJs.s;
      }, function (_useRootStoreLegacy00TJs) {
        TOOL_EXECUTOR_NODE_NAME = _useRootStoreLegacy00TJs.y;
        ...
        require_isEmpty = _isEmptyLegacy01XJs.t;
      }, function (_dateFormatterLegacy02FJs) {
        toTime = _dateFormatterLegacy02FJs.a;
        toDayMonth = _dateFormatterLegacy02FJs.i;
      }, function (_AnimatedSpinnerLegacy05hJs) {
        AnimatedSpinner_default = _AnimatedSpinnerLegacy05hJs.t;
      }],
      execute: function () {
