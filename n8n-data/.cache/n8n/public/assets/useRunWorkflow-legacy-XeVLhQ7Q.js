;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CSbUIQNN.js", "./truncate-legacy-BXBaeAHj.js", "./useTelemetry-legacy-K-mG0KNq.js", "./useToast-legacy-BNFd7XMO.js", "./constants-legacy-CvA6xS_6.js", "./useRootStore-legacy-BMRt4TVg.js", "./useExternalHooks-legacy-JPDKkvXd.js", "./useWorkflowSaving-legacy-C6zZ8vrh.js", "./retry-legacy-WzzNqxgG.js", "./executions.store-legacy-BQZSOquz.js", "./useCanvasOperations-legacy-qplvkXEk.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watch, useI18n, useLocalStorage, require_get, RemoveConnectionCommand, useSettingsStore, useHistoryStore, BulkCommand, displayForm, EnableNodeToggleCommand, injectWorkflowState, useDocumentTitle, AddNodeCommand, STORES, isEmpty, RemoveNodeCommand, useWorkflowHelpers, useWorkflowsStore, useTelemetry, AddConnectionCommand, useNodeHelpers, CanvasNodeDirtiness, useToast, LOCAL_STORAGE_RUN_DATA_WORKER, IN_PROGRESS_EXECUTION_ID, CHAT_TRIGGER_NODE_TYPE, generateNodesGraph, NodeConnectionTypes, createRunExecutionData, SINGLE_WEBHOOK_TRIGGERS, createHeartbeatMessage, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, retry, useExecutionsStore, useCanvasOperations, useHeartbeat, useReconnectTimer, useWebSocketClient, useEventSourceClient, proxyMarker, createEndpoint, releaseProxy, finalizer, throwMarker, isObject, transferHandlers, proxyCounter, proxyFinalizers, transferCache, worker, runDataWorker, usePushConnectionStore, LOCAL_STORAGE_AGENT_REQUESTS, useAgentRequestStore, import_get;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_RUN_DATA_WORKER = _constantsLegacy00NJs.Ds;
      ...
      }, function (_retryLegacy01fJs) {
        retry = _retryLegacy01fJs.t;
