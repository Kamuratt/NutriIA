;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CSbUIQNN.js", "./useTelemetry-legacy-K-mG0KNq.js", "./useToast-legacy-BNFd7XMO.js", "./constants-legacy-CvA6xS_6.js", "./assistant.store-legacy-Bo8vQA-C.js", "./useRootStore-legacy-BMRt4TVg.js", "./useExternalHooks-legacy-JPDKkvXd.js", "./useWorkflowSaving-legacy-C6zZ8vrh.js", "./useRunWorkflow-legacy-B4PtBckC.js", "./schemaPreview.store-legacy-BBf88M94.js", "./aiTemplatesStarterCollection.store-legacy-B3mA01je.js", "./readyToRun.store-legacy-DbIg0u1J.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, getExecutionErrorToastConfiguration, isPrebuiltAgentTemplateId, useSettingsStore, useCredentialsStore, useUIStore, getExecutionErrorMessage, getTriggerNodeServiceName, injectWorkflowState, useDocumentTitle, parse, isValidNodeConnectionType, sendGetWorkerStatus, codeNodeEditorEventBus, isTutorialTemplateId, globalLinkActionsEventBus, useWorkflowHelpers, useWorkflowsStore, clearPopupWindowState, useNodeTypesStore, useTelemetry, SampleTemplates, useNodeHelpers, useToast, TRIMMED_TASK_DATA_CONNECTIONS_KEY, isCommunityPackageName, generateNodesGraph, createRunExecutionData, WORKFLOW_SETTINGS_MODAL_KEY, EVALUATION_TRIGGER_NODE_TYPE, useBuilderStore, useAssistantStore, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, usePushConnectionStore, useRunWorkflow, useSchemaPreviewStore, useAITemplatesStarterCollectionStore, useReadyToRunStore, WORKER_HISTORY_LENGTH, STALE_SECONDS, useOrchestrationStore;
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        TRIMMED_TASK_DATA_CONNECTIONS_KEY = _constantsLegacy00NJs.Ia;
        isCommunityPackageName = _constantsLegacy00NJs.Ji;
        generateNodesGraph = _constantsLegacy00NJs._i;
        createRunExecutionData = _constantsLegacy00NJs.fi;
