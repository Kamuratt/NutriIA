const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-BCQ7lOd5.js","assets/index-BDDH_NIA.js","assets/index-CpPc1kM8.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aZ as useNDVStore, cO as useTelemetryContext, r as ref, go as useElementSize, x as computed, hr as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, dx as defineAsyncComponent, dw as Suspense, hs as VueJsonPretty, hm as __unplugin_components_0, n as normalizeClass, hn as MappingPill, gk as Draggable, aV as __vitePreload, ho as shorten, hq as getMappedExpression, ht as isString, hu as nonExistingJsonPath, bq as useExternalHooks, am as useTelemetry, _ as _export_sfc } from "./index-BDDH_NIA.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-BCQ7lOd5.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
