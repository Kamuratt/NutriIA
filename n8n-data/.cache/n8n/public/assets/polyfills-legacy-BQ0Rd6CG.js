(function() {
	...
	$$30({
		...
		if (someWithoutClosingOnEarlyError) return call$16(someWithoutClosingOnEarlyError, this, predicate);
	...
	$$26({
		...
		if (everyWithoutClosingOnEarlyError) return call$15(everyWithoutClosingOnEarlyError, this, predicate);
	...
	var require_iterator_close_all = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(iters, kind, value) {
			for (var i = iters.length - 1; i >= 0; i--) {
				...
				try {
					value = iteratorClose$11(iters[i].iterator, kind, value);
				} catch (error) {
					kind = "throw";
					value = error;
				}
			...
			return defineBuiltIns(create$3(IteratorPrototype$1), {
				...
				"return": function() {
					...
					if (IS_ITERATOR) {
						...
						return returnMethod ? call$14(returnMethod, iterator) : createIterResultObject(void 0, true);
					}
					if (state.inner) try {
						iteratorClose$10(state.inner.iterator, NORMAL);
					} catch (error) {
						return iteratorClose$10(iterator, THROW, error);
					}
	...
	var require_call_with_safe_iteration_closing = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(iterator, fn, value, ENTRIES) {
			try {
				return ENTRIES ? fn(anObject$12(value)[0], value[1]) : fn(value);
			} catch (error) {
	...
	$$25({
		...
		return new IteratorProxy$3(getIteratorDirect$9(this), { predicate });
	} });
	...
	$$22({
		...
		return new IteratorProxy$2(getIteratorDirect$6(this), { mapper });
	} });
	...
	$$8({
		...
		var result = [];
		iterate$1(getIteratorDirect$3(anObject$5(this)), push$3, {
			that: result,
			IS_RECORD: true
		});
		return result;
